#!/usr/bin/env python2
# -*- coding: UTF-8 -*-
# Author: Mr_yang <hy54yh@gmail.com>
import numpy
from numpy import *
...
class MFCCExtractor(object):
    ...
    def extract(self, signal):
        ...
        for f in xrange(frames):
            ...
            X[X < POWER_SPECTRUM_FLOOR] = POWER_SPECTRUM_FLOOR  
...
if __name__ == '__main__':
    fs, audio = wavfile.read("sad.wav")
    feature_mfcc=mfcc_feature((fs, audio))
